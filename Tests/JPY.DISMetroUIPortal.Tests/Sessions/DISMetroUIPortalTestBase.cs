...
namespace JPY.DISMetroUIPortal.Tests.Sessions
{
    public abstract class DISMetroUIPortalTestBase : AbpIntegratedTestBase
    {
        protected DISMetroUIPortalTestBase()
        {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<DISMetroUIPortalApplicationModule>();
            modules.Add<DISMetroUIPortalDataModule>();
        }

        public void UsingDbContext(Action<DISMetroUIPortalDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<DISMetroUIPortalDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<DISMetroUIPortalDbContext, T> func)
        {
            T result;
